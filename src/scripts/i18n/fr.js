	...
	.config(function(swaggerTranslatorProvider) {
		...
		swaggerTranslatorProvider
			.addTranslations('fr', {
				...
				oauthNoteTitle: 'Remarque',
				oauthNoteBodyBeforeLink: 'si votre entreprise a activé Application Whitelisting fonctionnalité, vous devriez également ajouter cette application à la liste blanche comme décrit dans ',
				oauthNoteBodyAfterLink: " en utilisant la clé d'application ",
				oauthNoteLinkTitle: 'cet article',
